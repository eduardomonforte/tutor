                    ...
                    <Row className="show-grid text-justify">
                        <Col xs={6} style={{ zIndex: '2' }}>
                            ...
                            <Row className="login">
                                <Col>
                                    <Link to="/Autho">
                                        <Button variant="danger" className="button" size="lg" block>Let's Go!</Button>
                                    </Link>
                                </Col>
                                <Col xs={7}>
                                    <p className="rogue-text">After clicking the button, you’ll be taken to an external authentication site to sign up/login. By signing up you agree to our Privacy Policy & Terms of Service. </p>
                                </Col>
                            </Row>
                        </Col>
